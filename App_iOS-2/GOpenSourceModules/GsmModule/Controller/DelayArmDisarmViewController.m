...
#define GSMArmingDelay [NSString stringWithFormat:@"%@11%@",self.userInfo.password,self.userInfo.armingTime]//延时布防

#define GSMPoliceCheck [NSString stringWithFormat:@"%@1200",self.userInfo.password]//报警查询
#define GSMPoliceDelay [NSString stringWithFormat:@"%@13%@",self.userInfo.password,self.userInfo.policeTime]//延时报警
...
-(void)initView{
    [self.view addSubview:[self addSettingViewWithFrame:CGRectMake(0,64, self.view.frame.size.width, smallviewH) andImageName:@"DelayArmDisarmViewController_image_1" andTitle:NSLocalizedString(@"delay_arm", nil) andViewTag:1]];
    
     [self.view addSubview:[self addSettingViewWithFrame:CGRectMake(0,64+smallviewH, self.view.frame.size.width, smallviewH) andImageName:@"DelayArmDisarmViewController_image_2" andTitle:NSLocalizedString(@"d_callpol", nil) andViewTag:2]];
}
