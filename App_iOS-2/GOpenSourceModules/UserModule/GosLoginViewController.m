...
- (void)viewDidLoad {
    ...
    self.gsmButton.backgroundColor = [GosCommon sharedInstance].buttonColor;
    [self.gsmButton setTitleColor:[GosCommon sharedInstance].buttonTextColor forState:UIControlStateNormal];
    [self.gsmButton.layer setCornerRadius:22.0];
...
- (IBAction)clickGsmbutton:(UIButton *)sender {
    GSMUserInfo *userinfo = [GSMUserInfo retunUserInfo];
    if (userinfo == nil) {
